...
export default function App() {
  ...
  return <div className="app">
    <header className="site-header"><button className="brand" onClick={() => setView('designer')}><span>CT</span><div><strong>Consumption Tax Lab</strong><small>Static reform simulator · Iteration 1</small></div></button><div className="status-pill"><i />2024 baseline</div></header>
    ...
    <footer><p>Static accounting model · Tax year / data year 2024 · No growth, transition, or behavioral effects</p><a href="https://github.com/pcarlsgaard/tax_reform" target="_blank" rel="noreferrer">Methodology & source</a></footer>
  </div>;
}

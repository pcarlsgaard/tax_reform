...
import { baseline, calculateFederalProgramSavings, calculateMacro, microdata2025, type ReformSettings, type TransferReplacementSettings } from '../model';
...
export function National({ settings, transferSettings }: { settings: ReformSettings; transferSettings: TransferReplacementSettings }) {
  ...
  const compensationTotal = compensation.cashWagesAndSalaries
    ...
    + compensation.employerPensionAndInsurance;
  return <main className="page-shell">
    ...
    <section className="table-card compact">
      ...
      <div className="responsive-table"><table><thead><tr><th>Compensation component</th><th>BEA control</th><th>Exempt share</th></tr></thead><tbody>
        ...
        <tr><td>Employer pension and insurance supplements</td><td>{moneyB(compensation.employerPensionAndInsurance)}</td><td>{percent(settings.employerPensionInsuranceExemptionShare)}</td></tr>
